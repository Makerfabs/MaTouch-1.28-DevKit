...
void ui_Screen1_screen_init(void)
{
    ...
    lv_label_set_text(ui_Label1, "Position");
    ...
    lv_label_set_text(ui_Label2, "Velocity");
    lv_obj_set_style_text_color(ui_Label2, lv_color_hex(0x2095F6), LV_PART_MAIN | LV_STATE_DEFAULT);
