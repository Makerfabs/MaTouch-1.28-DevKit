...
void ui_Screen1_screen_init(void)
{
    ...
    lv_obj_set_style_bg_img_src(ui_Screen1, &ui_img_7_png, LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_bg_color(ui_Button1, lv_color_hex(0xEADEDE), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui_Label15, "SHIFT");
    ...
    lv_obj_set_style_bg_color(ui_Button2, lv_color_hex(0xEADEDE), LV_PART_MAIN | LV_STATE_DEFAULT);
    ...
    lv_label_set_text(ui_Label16, "SET");
    ...
    lv_obj_set_x(ui_Label3, 61);
    lv_obj_set_y(ui_Label3, 0);
    lv_obj_set_align(ui_Label3, LV_ALIGN_CENTER);
    lv_label_set_text(ui_Label3, "59");
    ...
    lv_obj_set_y(ui_Label24, -65);
    lv_obj_set_align(ui_Label24, LV_ALIGN_CENTER);
    lv_label_set_text(ui_Label24, "Set RTC Time");
