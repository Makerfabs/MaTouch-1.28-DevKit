...
void ui_Screen2_screen_init(void)
{
    ...
    lv_obj_set_style_bg_img_src(ui_Screen2, &ui_img_11_png, LV_PART_MAIN | LV_STATE_DEFAULT);

    ui_Arc1 = lv_arc_create(ui_Screen2);
    lv_obj_set_width(ui_Arc1, 194);
    ...
    lv_obj_set_style_arc_color(ui_Arc1, lv_color_hex(0xE21D4A), LV_PART_INDICATOR | LV_STATE_DEFAULT);
    lv_obj_set_style_arc_opa(ui_Arc1, 255, LV_PART_INDICATOR | LV_STATE_DEFAULT);

    lv_obj_set_style_bg_color(ui_Arc1, lv_color_hex(0xE51B1B), LV_PART_KNOB | LV_STATE_DEFAULT);
